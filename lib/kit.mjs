...
export async function cliMain(argv, invokedAs = "node lib/kit.mjs") {
  ...
  if (!cmd || cmd === "--help" || cmd === "-h") {
    console.log(`Usage:
  ${invokedAs} install <target-repo> [--runtime cursor|zed|claude|both|all] [--features ${FEATURE_IDS.join(",")}|all] [--repo-name NAME] [--stealth] [--mcp http|stdio|PORT] [--gitnexus-cmd CMD] [--quick] [--no-setup] [--skip-verify] [--prettierignore|--no-prettierignore]
