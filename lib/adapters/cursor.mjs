...
function writeCursorContract(absTarget, features) {
...
export const cursorAdapter = {
  ...
  wire(absTarget, { features, mcpTransport = STDIO_TRANSPORT } = {}) {
    ...
    const wrote = writeCursorContract(absTarget, features);
    ...
    cfg.mcpServers ??= {};
    cfg.mcpServers.gitnexus = mcpEntry(mcpTransport);
    writeJson(mcpPath, cfg);
    return wrote;
  },
