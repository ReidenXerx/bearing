...
function mergeMcpJson(absTarget, transport = STDIO_TRANSPORT, gitnexusCmd) {
...
function mergeClaudeMd(absTarget, repoName, features = null, persona, personaNote) {
...
export const claudeAdapter = {
  ...
  wire(absTarget, { repoName, features, mcpTransport, gitnexusCmd, persona, personaNote }) {
    ...
    if (!features || features.has("gitnexus")) mergeMcpJson(absTarget, mcpTransport, gitnexusCmd);
    else stripMcpServer(absTarget);
    mergeClaudeSettings(absTarget);
    mergeClaudeMd(absTarget, repoName, features, persona, personaNote);
  },
