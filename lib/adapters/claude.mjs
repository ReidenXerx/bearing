...
function mergeClaudeMd(absTarget, repoName, features = null, persona) {
...
export const claudeAdapter = {
  ...
  wire(absTarget, { repoName, features, mcpTransport, gitnexusCmd, persona }) {
    ...
    mergeClaudeMd(absTarget, repoName, features, persona);
  },
